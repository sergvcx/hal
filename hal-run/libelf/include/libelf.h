...
// Интерфейсный файл описывающий типы, классы, и методы классов используемые при работе с файлами формата ELF
...
const Elf32_Half  EM_ARM            = 40;   // ARM
const Elf32_Half  EM_NM6405         = 64050;// NM6405
const Elf32_Half  EM_NM640X         = 64050;// All of ours, discrimined by e_flags
const Elf32_Half  EM_SOC            = 64051;// NMC3 soc
//const Elf32_Half  EM_CURRENTPROC    = EM_NEUROCHIP;

    // расширение типов машин EM_NM640X

const Elf32_Half  EM_NM640X_6405    = 0;// NM6405 (0 for legacy)
const Elf32_Half  EM_NM640X_6403    = 1;// NM6403
const Elf32_Half  EM_NM640X_NMC3    = 2;// NM6405, NMC3 soc, ...
const Elf32_Half  EM_NM640X_SOC     = 3;// NMC3 soc
const Elf32_Half  EM_NM640X_6407    = 4;// NM6407
const Elf32_Half  EM_NM640X_NMC4    = 4;// NM6407
const Elf32_Half  EM_NM640X_NMC4I   = 5;// NM6407 fixed
const Elf32_Half  EM_NM640X_NMC4F   = 6;// NM6407 float
const Elf32_Half  EM_NM640X_NMC4FI  = 7;// NM6407 fixed+float
...
typedef Elf32_Half MachineFullType;
...
struct Elf32_Ehdr {
    public:
        ...
        void setMachine( Elf32_Half TargetProc );
        Elf32_Half getMachine() const;
        static Elf32_Word convertEMachine( Elf32_Half oldEMachine, Elf32_Word oldEFlags );
};
...
struct Elf32_Sym {
    public:
      ...
      { }
        ...
        Elf32_Sym( const Elf32_Sym& src ) :   
                        st_name(src.st_name),
                        st_value(src.st_value),
                        st_size(src.st_size),
                        st_info(src.st_info),
                        st_other(src.st_other),
                        st_shndx(src.st_shndx)
      { }
};
...
//                                    // ELF файл
	...
	ELF(char *buf, unsigned int siz, ELF_CMD c) throw(ELF_ERROR);
        ...
        Elf32_Ehdr  *   GetEhdr(Elf32_Half TargetProc = EM_NM640X_6403) throw(ELF_ERROR);

            // создает заголовок ELF файла
        Elf32_Ehdr  *   NewEhdr(Elf32_Half TargetProc = EM_NM640X_6403) throw(ELF_ERROR);
