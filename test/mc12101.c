...
void test_halLoadProgramFile_whenFirstBoardZeroCoreWrongProgramFile_shouldReturnFailed(){
    // Arrange
    HalBoard *board = arrangeFirstBoardMC12101();
    HalCore core;
    core.core = 0;
...
void test_halLoadProgramFile_whenFirstBoardZeroCoreDummyFile_shouldReturnSuccesful(){
    // Arrange
    HalBoard *board = arrangeFirstBoardMC12101();
    HalCore core;
    core.core = 0;
...
void test_halResult_whenFirstBoardZeroCoreDummyFile_shouldGetResult(){
    // Arrange
    HalBoard *board = arrangeFirstBoardMC12101();
    HalCore core;
    core.core = 0;
...
void test_halResult_whenFirstBoardZeroCoreLoadFactorial_shouldGetCorrectResult(){
    // Arrange
    HalBoard *board = arrangeFirstBoardMC12101();
    HalCore core;
    core.core = 0;
...
int main(int argc, char *argv[]){
    ...
    test_halLoadProgramFile_whenFirstBoardZeroCoreWrongProgramFile_shouldReturnFailed();
    test_halLoadProgramFile_whenFirstBoardZeroCoreDummyFile_shouldReturnSuccesful();
    test_halResult_whenFirstBoardZeroCoreDummyFile_shouldGetResult();
    test_halResult_whenFirstBoardZeroCoreLoadFactorial_shouldGetCorrectResult();
    return 0;
}